...
// The main App component that renders the button and quantity selector
export default function QunatityAdd() {
  // State to manage the quantity, initialized to 1
  ...
  return (
      ...
      <div className="flex flex-col  gap-8">
        {/* The main container for the quantity selector and add-to-bag button */}
        <div className="mt-8 flex gap-10">
          ...
          <button className="flex justify-center items-center gap-2 px-6 py-3 bg-gray-800 text-white hover:bg-black transition-colors  max-w-xs md:max-w-md lg:max-w-lg">
            ...
            <svg className="self-center w-5 h-5" viewBox="0 0 14 17" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
