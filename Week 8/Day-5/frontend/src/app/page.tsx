...
export default function UploadPage() {
  ...
  const onDrop = useCallback((acceptedFiles: File[]) => {
    ...
    if (uploadedFile) {
      ...
      const sanitizedFile = new File([uploadedFile], sanitized, { type: uploadedFile.type });
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          <h2 className="text-xl font-semibold text-gray-800 mb-6">Upload PDF Document</h2>
          ...
          <AnimatePresence>
            ...
            {error && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="mt-4 p-3 bg-red-50 rounded-lg flex items-center"
              >
