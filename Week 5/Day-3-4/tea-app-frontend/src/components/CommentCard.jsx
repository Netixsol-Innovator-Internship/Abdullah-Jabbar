...
export default function CommentCard({ comment, onReplyOpen }) {
  ...
  async function toggleLike() {
    ...
    try {
      ...
      if (
        ...
        setError({
          type: "auth",
          message: "You need to be logged in to like reviews.",
        });
      }
    } finally {
      setLikeBusy(false);
  ...
  async function handlePostReply() {
    ...
    try {
      ...
      if (
        ...
        setError({
          type: "auth",
          message: "You need to be logged in to reply to reviews.",
        });
      } else {
        setError({
          type: "general",
    ...
    <div className="p-4 bg-white rounded shadow mb-3">
      <div className="flex items-start">
        <img
          ...
          alt={comment.author?.username || comment.authorName || "avatar"}
          width={40}
          height={40}
